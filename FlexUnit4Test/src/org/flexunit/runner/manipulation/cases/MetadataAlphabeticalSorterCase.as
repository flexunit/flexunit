package org.flexunit.runner.manipulation.cases
{
	...
	import org.flexunit.runner.manipulation.MetadataAlphabeticalSorter;
	...
	{		
		...
		private var metaDataAlphaSorter : OrderArgumentPlusAlphabeticalSorter;
		...
		public function setupSorter():void {
			metaDataAlphaSorter = new OrderArgumentPlusAlphabeticalSorter();
		}
